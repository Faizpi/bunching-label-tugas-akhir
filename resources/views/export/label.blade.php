...
<head>
    ...
    <style>
        ...
        #section-to-print td:first-child { width: 35%; }
        #section-to-print td:nth-child(2) { width: 5%; text-align:center; }
        #section-to-print td:last-child { width: 60%; }
        button {
            text-align: center;
            display: block;
            margin: 20px auto;
        ...
        @media print {
            ...
            #section-to-print { position: absolute; left: 200; top: -10; }
            button { display: none; }
        }
    </style>
</head>
